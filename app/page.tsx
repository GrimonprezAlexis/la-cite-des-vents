                ...
                <div className="relative h-[600px] md:h-[750px] lg:h-[850px] w-full overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="container mx-auto px-4 text-center text-white">
                      <div className="max-w-5xl mx-auto flex flex-col items-center mb-8rem">
                        ...
                        >
                          ...
                          <Link
                            href="https://www.thefork.ch/restaurant/la-cite-des-vents-r27342#booking="
                            target="_blank"
