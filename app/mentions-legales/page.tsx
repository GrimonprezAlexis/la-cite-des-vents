      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="mb-6 shadow-lg">
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                <strong>Nom de l&apos;entreprise :</strong> La Cité des Vents SA
              </p>
              <p>
        ...
        <Card className="mb-6 shadow-lg">
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                Ce site web est hébergé par un prestataire d&apos;hébergement
                professionnel garantissant la sécurité et la disponibilité des
                données.
              </p>
            </div>
          </CardContent>
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                ...
                graphiques) est la propriété exclusive de La Cité des Vents SA,
                sauf mention contraire.
              </p>
              <p>
                Toute reproduction, distribution, modification ou utilisation du
                contenu sans autorisation écrite préalable est strictement
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                ...
                (LPD), nous nous engageons à protéger la confidentialité de vos
                données personnelles.
              </p>
              <p>
                <strong>Collecte des données :</strong> Les informations
                personnelles que vous nous transmettez via le formulaire de
                contact (nom, email, téléphone, message) sont collectées
                uniquement pour répondre à vos demandes.
              </p>
              <p>
                <strong>Utilisation des données :</strong> Vos données sont
                utilisées exclusivement dans le cadre de notre relation
                commerciale et ne sont jamais transmises à des tiers sans votre
                consentement.
              </p>
              <p>
                ...
                contactez-nous au +41 22 793 03 50.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                ...
                sur votre appareil lors de votre visite.
              </p>
              <p>
                Vous pouvez configurer votre navigateur pour refuser les
                cookies, mais cela peut affecter certaines fonctionnalités du
                site.
              </p>
            </div>
          </CardContent>
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                ...
                jour et exactes. Toutefois, nous ne pouvons garantir
                l&apos;exactitude, la complétude ou l&apos;actualité des
                informations fournies.
              </p>
              <p>
                La Cité des Vents SA ne peut être tenue responsable des dommages
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-3 text-gray-700">
              <p>
                ...
                à la compétence exclusive des tribunaux du canton de Genève.
              </p>
            </div>
          </CardContent>
        </Card>
